    ...
    **/
    tick: function(target, blackboard) {
      ...
      for (i=lastOpenNodes.length-1; i>=start; i--) {
        b3.NodesById.get(lastOpenNodes[i])._close(tick);
      }
